...
namespace BEPUik
{
    ...
    public class IKDistanceLimit : IKLimit
    {
        ...
        public IKDistanceLimit(Bone connectionA, Bone connectionB, System.Numerics.Vector3 anchorA, System.Numerics.Vector3 anchorB, float minimumDistance, float maximumDistance)
        ...
        protected internal override void UpdateJacobiansAndVelocityBias()
        {
            ...
            if (currentDistance > Toolbox.Epsilon)
            {
                ...
                else if (currentDistance < minimumDistance)
                {
                    ...
                    Vector3Ex.Negate(ref linearA, out linearA);
                }
