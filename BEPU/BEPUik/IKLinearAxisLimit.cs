...
namespace BEPUik
{
    ...
    public class IKLinearAxisLimit : IKLimit
    {
        ...
        public IKLinearAxisLimit(Bone connectionA, Bone connectionB, System.Numerics.Vector3 lineAnchor, System.Numerics.Vector3 lineDirection, System.Numerics.Vector3 anchorB, float minimumDistance, float maximumDistance)
        ...
        protected internal override void UpdateJacobiansAndVelocityBias()
        {
            ...
            QuaternionEx.Transform(ref LocalLineAnchor, ref ConnectionA.Orientation, out offsetA);
            ...
            if (currentDistance > maximumDistance)
            {
                ...
                velocityBias = new System.Numerics.Vector3(errorCorrectionFactor * (currentDistance - maximumDistance), 0, 0);
            }
            else if (currentDistance < minimumDistance)
            {
                //We are exceeding the minimum limit.
                velocityBias = new System.Numerics.Vector3(errorCorrectionFactor * (minimumDistance - currentDistance), 0, 0);
                //The limit can only push in one direction. Flip the jacobian!
                Vector3Ex.Negate(ref lineDirection, out lineDirection);
            }
            else if (currentDistance - minimumDistance > (maximumDistance - minimumDistance) * 0.5f)
            {
                ...
                velocityBias = new System.Numerics.Vector3(currentDistance - maximumDistance, 0, 0);
            }
            else
            {
                //The objects are closer to hitting the minimum limit.
                velocityBias = new System.Numerics.Vector3(minimumDistance - currentDistance, 0, 0);
                //The limit can only push in one direction. Flip the jacobian!
                Vector3Ex.Negate(ref lineDirection, out lineDirection);
            }
